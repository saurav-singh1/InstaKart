...
<body>
                ...
                <div class="row mx-auto container">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="category" id="category_one" checked>
                            <label for="flexRadioDefault1" class="form-check-label">Shoes
                            </label>
                        </div>

                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="category" id="category_two" checked>
                            <label for="flexRadioDefault2" class="form-check-label">Coat
                            </label>
                        </div>

                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="category" id="category_three" checked>
                            <label for="flexRadioDefault3" class="form-check-label">Watches
                            </label>
                        </div>

                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="category" id="category_four" checked>
                            <label for="flexRadioDefault4" class="form-check-label">Bags
                            </label>
                        </div>
                    </div>
                </div>
    ...
    <section id="featured">
        ...
        <div class="row mx-auto container ">
            <?php include('server/get_womens.php'); ?>
            <?php while ($row = $womens_products->fetch_assoc()) { ?>
        ...
        <div class="row mx-auto container ">
            <?php include('server/get_womens.php'); ?>
            <?php while ($row = $womens2_products->fetch_assoc()) { ?>
                <div class="product text-center col-lg-3 col-md-4 col-sm-10">
                    <img class="img-fluid mb-3" src="assets\img\<?php echo $row['product_image']; ?>" alt="Sports shoes">
                    <div class="star">
                        <i class="fas fa-star"></i>
        ...
        <div class="row mx-auto container ">
            <?php include('server/get_womens.php'); ?>
            <?php while ($row = $womens3_products->fetch_assoc()) { ?>
                <div class="product text-center col-lg-3 col-md-4 col-sm-10">
                    <img class="img-fluid mb-3" src="assets\img\<?php echo $row['product_image']; ?>" alt="Sports shoes">
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination" style="margin-top:-105px;">
