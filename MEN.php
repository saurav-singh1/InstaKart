...
<section id="featured">
    ...
    <div class="row mx-auto container">
        <?php include('server/get_mens.php');?>
        <?php while($row= $mens_products->fetch_assoc()){?>
    ...
    <div class="row mx-auto container">
        <?php include('server/get_mens.php');?>
        <?php while($row= $mens2_products->fetch_assoc()){?>
        <div class="product text-center col-lg-3 col-md-4 col-sm-10">
            <img class="img-fluid mb-3" src="assets\img\<?php echo $row['product_image'];?>" alt="Sports shoes">
            <div class="star">
                <i class="fas fa-star"></i>
    ...
    <div class="row mx-auto container">
        <?php include('server/get_mens.php');?>
        <?php while($row= $mens3_products->fetch_assoc()){?>
        <div class="product text-center col-lg-3 col-md-4 col-sm-10">
            <img class="img-fluid mb-3" src="assets\img\<?php echo $row['product_image'];?>" alt="Sports shoes">
            <div class="star">
                <i class="fas fa-star"></i>
